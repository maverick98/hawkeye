...
public class CountryFetcher extends HawkPluginModule {
    ...
    public Country[] sortName(Object... args) {
        ...
        Country[] tmpArray = tmpSet.toArray(new Country[]{});
        Arrays.sort(tmpArray, new Comparator() {
            @Override
            public int compare(Object o1, Object o2) {
                Country thisCountry = (Country) o1;
                Country thatCountry = (Country) o2;
                return thisCountry.getName().compareTo(thatCountry.getName());
            }
        });
        return tmpArray;
    }
