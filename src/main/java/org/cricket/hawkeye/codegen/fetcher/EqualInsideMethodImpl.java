 ...
 */
@ScanMe(true)
public class EqualInsideMethodImpl extends AbstractFetcherMethodImpl {

    public EqualInsideMethodImpl() {
    }

    public EqualInsideMethodImpl(boolean b) {
        super(b);
    }
    @Override
    public IFetcherMethodImpl create(SourceVO sourceVO) throws HawkEyeCodeTemplateException {
        return super.create(sourceVO);
    }
