...
import org.cricket.hawkeye.service.download.ICricDataDownloadControlService;
...
public class App {
    ...
    public static void main(String[] args) throws Exception  {
       ...
       HawkEyeConfigHelper.getInstance().configure();
        //HawkEyeSetup setup = new HawkEyeSetup();
        //  setup.configure();
        //ApplicationContext appContext = setup.getAppContext();

        ICricDataDownloadService cricDataDownloadService = (ICricDataDownloadService) AppContainer.getInstance().getBean(ICricDataDownloadControlService.class);
